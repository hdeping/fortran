...
subroutine del_proc(proc, site)
  ...
  !ASSERT(proc>=0,"add_proc: proc has to be positive or zero")
  !ASSERT(proc<=nr_of_proc,"add_proc: proc has to be less or equal nr_of_proc.")
  ! Make sure site is in the right range
  !ASSERT(site>=0,"add_proc: site has to be positive or zero")
  !ASSERT(site<=volume,"base/add_proc: site needs to be in volume")
...
subroutine add_proc(proc, site)
  ...
  ! Make sure proc_nr is in the right range
  !ASSERT(proc>=0,"base/add_proc: proc has to be positive or zero")
  !ASSERT(proc<=nr_of_proc,"base/add_proc: proc has to be less or equal nr_of_proc.")

  ! Make sure site is in the right range
  !ASSERT(site>=0,"base/add_proc: site has to be positive or zero")
  !ASSERT(site<=volume,"base/add_proc: site needs to be in volume")
...
end_subroutine_add_proc
!}}}
!pure function can_do{{{
...
end_subroutine_reset_site


!}}}
!subroutine reload_system{{{
...
subroutine save_system()
  ...
  write(filehandler,'(a,es14.7)')' walltime   ',walltime
...
end_subroutine_save_system


!}}}
!subroutine set_rate_const{{{
subroutine set_rate_const(proc_nr, rate)
  ...
  !   * the field within the process, but the meaning differs as explained
  !     under 'switch'
  !ASSERT(proc_nr<=nr_of_proc,"base/set_rate_const: proc_nr less or equal nr_of_proc.")
  rates(proc_nr) = rate

end_subroutine_set_rate_const
...
end_subroutine_update_accum_rate
...
end_subroutine_update_integ_rate
!------ S. Matera 09/18/2012------
...
end_subroutine_allocate_system


!}}}
!subroutine is_allocated{{{
subroutine is_allocated(result)
  logical, intent(out) :: result
  result = allocated(avail_sites)
end_subroutine_is_allocated
...
end_subroutine_deallocate_system
...
end_subroutine_set_system_name


!}}}
!subroutine set_kmc_time{{{
...
end_subroutine_set_kmc_time


!}}}
!subroutine get_kmc_time{{{
...
end_subroutine_get_kmc_time


!}}}
!subroutine get_kmc_time_step{{{
...
end_subroutine_get_kmc_time_step


!}}}
!subroutine get_procstat{{{
...
end_subroutine_get_nrofsites


!}}}
!subroutine get_avail_site{{{
...
end_subroutine_get_avail_site


!}}}
!subroutine get_accum_rate{{{
...
end_subroutine_get_accum_rate

!------ S. Matera 09/18/2012------
!}}}
!subroutine get_integ_rate{{{
...
end_subroutine_get_rate


!}}}
!subroutine increment_procstat{{{
...
end_subroutine_increment_procstat


!}}}
!subroutine get_walltime{{{
...
end_subroutine_get_volume

!}}}
!subroutine get_kmc_step{{{
...
end_subroutine_get_kmc_step


!}}}
!subroutine determine_procsite{{{
subroutine determine_procsite(ran_proc, ran_site, proc, site)
  ...
  !ASSERT(ran_proc>=0,"base/determine_procsite: ran_proc has to be positive")
  !ASSERT(ran_proc<=1,"base/determine_procsite: ran_proc has to be less or equal 1")
  !ASSERT(ran_site>=0,"base/determine_procsite: ran_site has to be positive")
  !ASSERT(ran_site<=1,"base/determine_procsite: ran_site has to be less or equal 1")
  ...
  !ASSERT(site<=volume,"base/determine_procsite: tries to return site larger than volume")


end_subroutine_determine_procsite
...
subroutine update_clocks(ran_time)
  ...
  !ASSERT(ran_time>=0.,"base/update_clocks: ran_time variable has to be positive.")
  !ASSERT(ran_time<=1.,"base/update_clocks: ran_time variable has to be less than 1.")
...
pure function get_species(site)
  ...
  !! DEBUG
  !print *, site
  !!ASSERT(site>=1,"kmos/base/get_species was asked for a zero or negative site")
  !!ASSERT(site<=volume,"kmos/base/get_species was asked for a site outside the lattice")
...
subroutine replace_species(site, old_species, new_species)
  ...
  !ASSERT(site<=volume,"kmos/base/replace_species was asked for a site outside the lattice")
...
end_subroutine_replace_species


!}}}
!subroutine interval_search_real{{{
subroutine interval_search_real(arr, value, return_field)
  ...
  !ASSERT(value<=arr(mid),"interval_search_real has an internal error")

  return_field = mid


end_subroutine_interval_search_real

!}}}
!subroutine ASSERTion_fail{{{
...
end_subroutine_ASSERTion_fail

!}}}
!subroutine set_null_species{{{
...
end_subroutine_set_null_species

!}}}
!subroutine get_null_species{{{
...
end_subroutine_get_null_species
!}}}
