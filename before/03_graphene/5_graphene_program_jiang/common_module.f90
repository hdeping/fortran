...
integer,parameter        ::    x_scr = 10                ! location of start point for drawing graphic, Unit: pixel
integer,parameter        ::    y_scr = 10
integer,parameter        ::    w_scr = 1200                ! width of the graphic, Unit: pixel
integer,parameter        ::    h_scr = 800                ! heigth of the graphic, Unit: pixel
...
!******************************************************
end module common_module€krend