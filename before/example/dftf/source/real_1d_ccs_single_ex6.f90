...
!*****************************************************************************
      ...
      Program REAL_1D_CCS_SINGLE_EX6
      ...
      real :: X_OUT_2D(M_MAX+2,N_MAX)
      real :: X_OUT   ((M_MAX+2)*N_MAX)
...
!
      ...
      call ZERO_INIT_REAL_S(X_OUT, (M_MAX+2)*N_MAX)
