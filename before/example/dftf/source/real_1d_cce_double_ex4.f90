...
!*****************************************************************************
      ...
      Program REAL_1D_CCE_DOUBLE_EX4
      ...
      complex(8) :: X_OUT_2D(M_MAX,N_MAX/2+1)
      complex(8) :: X_OUT   (M_MAX*(N_MAX/2+1))
...
!
      ...
      call ZERO_INIT_COMPLEX_Z(X_OUT, M_MAX*(N_MAX/2+1))
...
!
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        call PRINT_THREE_VECTORS_Z(X_OUT, n/2+1, dist_out, strides_out)
      end if
