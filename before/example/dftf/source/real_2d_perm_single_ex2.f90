...
!*****************************************************************************
      ...
      Program REAL_2D_PERM_SINGLE_EX2
      ...
      real(4) :: X_OUT_2D(M_MAX,N_MAX)
      real(4) :: X_OUT   (M_MAX*N_MAX)
...
!
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        call PRINT_THREE_VECTORS_S(X_OUT, m, M_MAX, strides_out)
      end if
