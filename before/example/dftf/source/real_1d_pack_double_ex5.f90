...
!       for double precisiondata which are allocated in two-dimension array.
...
!*****************************************************************************
      ...
      Program REAL_1D_PACK_DOUBLE_EX5
...
!
      ...
      if (LEGEND_PRINT) then
          print *
          print *, 'REAL_1D_PACK_DOUBLE_EX5'
          print *, 'Real-to-complex and complex-to-real transform for double precisiondata'
          print *
