...
!*****************************************************************************
      ...
      Program REAL_1D_CCS_SINGLE_EX4
      ...
      real :: X_OUT_2D(M_MAX,N_MAX+2)
      real :: X_OUT   (M_MAX*(N_MAX+2))
...
!
      ...
      call ZERO_INIT_REAL_S(X_OUT, M_MAX*(N_MAX+2))
...
!
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        call PRINT_THREE_VECTORS_S(X_OUT, n+2, dist_out, strides_out)
      end if
