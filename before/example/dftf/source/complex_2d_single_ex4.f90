...
!
!       Forward-Backward 2D complex transform for single precisiondata not inplace.
...
!
      ...
      if (LEGEND_PRINT) then
          print *
          print *, 'COMPLEX_2D_SINGLE_EX4'
          print *, 'Forward-Backward 2D complex transform for single precisiondata'
...
!     for multiple 2D transform along the 1-st dimension of 3D array
!
...
!
      ...
      do i=1, multiple
          call INIT_MULTIPLE_2D_COLUMNS_C(X_IN_3D(i,1,1), m, n, strides_in)
      end do
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        print *
          do i=1, multiple
             print 908, i
             call PRINT_THREE_2D_COLUMNS_C(X_IN_3D(i,1,1), m, strides_in)
          end do
      end if
...
!
      ...
      if (ADVANCED_DATA_PRINT) then
          ...
          do i=1, multiple
             print 908, i
             call PRINT_THREE_2D_COLUMNS_C(X_OUT_3D(i,1,1), m, strides_out)
          end do
      end if
