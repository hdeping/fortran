...
!*****************************************************************************
      ...
      Program REAL_2D_PERM_DOUBLE_EX4
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        print *, 'INPUT vector X (2D columns)'
          do i=1, multiple
              print *
              print 908, i
              call PRINT_THREE_FIRST_VECTORS_2D_D(X_IN_3D(i,1,1), lengths, strides_in)
          end do
      end if
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        print *, 'Forward OUTPUT vector X (2D columns)'
          do i=1, multiple
              print *
              print 908, i
              call PRINT_THREE_FIRST_VECTORS_2D_D(X_OUT_3D(i,1,1), lengths, strides_out)
          end do
      end if
