...
!*****************************************************************************
      ...
      Program REAL_2D_CCS_SINGLE_EX6
      ...
      real(4) :: X_OUT_3D(M_MAX+2,N_MAX,K_MAX+2)
      real(4) :: X_OUT   ((M_MAX+2)*N_MAX*(K_MAX+2))
...
!
      ...
      call ZERO_INIT_REAL_S(X_OUT,(M_MAX+2)*N_MAX*(K_MAX+2))
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        print *, 'Forward OUTPUT vector X (2D columns)'
          do i=1, multiple
              print *
              print 908, i
              call PRINT_THREE_FIRST_AND_THREE_LAST_VECTORS_2D_S(X_OUT_3D(1,i,1), lengths, strides_out)
          end do
      end if
