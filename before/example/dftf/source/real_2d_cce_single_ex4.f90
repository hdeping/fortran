...
!*****************************************************************************
      ...
      Program REAL_2D_CCE_SINGLE_EX4
      ...
      complex(4) :: X_OUT_3D(M_MAX,N_MAX/2+1,K_MAX)
      complex(4) :: X_OUT   (M_MAX*(N_MAX/2+1)*K_MAX)
...
!
      ...
      call ZERO_INIT_COMPLEX_C(X_OUT, M_MAX*(N_MAX/2+1)*K_MAX)
