...
!*****************************************************************************
      ...
      Program REAL_2D_CCE_DOUBLE_EX2
      ...
      complex(8) :: X_OUT_2D(M_MAX/2+1,N_MAX)
      complex(8) :: X_OUT   ((M_MAX/2+1)*(N_MAX))
...
!
      ...
      call ZERO_INIT_COMPLEX_Z(X_OUT,(M_MAX/2+1)*(N_MAX))
...
!
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        call PRINT_THREE_VECTORS_Z(X_OUT, m/2+1, M_MAX/2+1, strides_out)
      end if
