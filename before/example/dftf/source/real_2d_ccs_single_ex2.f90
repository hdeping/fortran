...
!*****************************************************************************
      ...
      Program REAL_2D_CCS_SINGLE_EX2
      ...
      real(4) :: X_OUT_2D(M_MAX+2,N_MAX+2)
      real(4) :: X_OUT   ((M_MAX+2)*(N_MAX+2))
...
!
      ...
      call ZERO_INIT_REAL_S(X_OUT,(M_MAX+2)*(N_MAX+2))
...
!
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        call PRINT_THREE_FIRST_AND_THREE_LAST_VECTORS_2D_S(X_OUT, lengths, strides_out)
      end if
