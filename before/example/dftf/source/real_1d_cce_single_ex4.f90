...
!*****************************************************************************
      ...
      Program REAL_1D_CCE_SINGLE_EX4
      ...
      complex :: X_OUT_2D(M_MAX,N_MAX/2+1)
      complex :: X_OUT   (M_MAX*(N_MAX/2+1))
...
!
      ...
      call ZERO_INIT_COMPLEX_C(X_OUT, M_MAX*(N_MAX/2+1))
...
!
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        call PRINT_THREE_VECTORS_C(X_OUT, n/2+1, dist_out, strides_out)
      end if
