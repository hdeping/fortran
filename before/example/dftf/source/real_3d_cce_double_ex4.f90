...
!
!       Forward-Backward 3D real transform for double precision data not inplace.
!
!*****************************************************************************
...
!*****************************************************************************
      ...
      Program REAL_3D_CCE_DOUBLE_EX4
      ...
      real (KIND=8) :: X_IN_3D (M_MAX,N_MAX,K_MAX)
      real (KIND=8) :: X_IN    (M_MAX*N_MAX*K_MAX)
      complex (KIND=8) :: X_OUT_3D(M_MAX/2+1,N_MAX,K_MAX)
      complex (KIND=8) :: X_OUT   ((M_MAX/2+1)*N_MAX*K_MAX)
      real (KIND=8) :: X_EXP   (M_MAX*N_MAX*K_MAX)
...
!
      ...
      if (LEGEND_PRINT) then
          print *
          print *, 'REAL_3D_CCE_DOUBLE_EX4'
          print *, 'Forward-Backward 3D real transform for double precision data'
          print *
...
!
      ...
      call ZERO_INIT_COMPLEX_Z(X_OUT, (M_MAX/2+1)*N_MAX*K_MAX)
      call INIT_3D_COLUMNS_D(X_IN, m, n, k, strides_in)
...
!           INPUT X(1:m, 1:3, i) (3D columns)
            print 911, i
            call PRINT_THREE_2D_COLUMNS_D(X_IN_3D(1,1,i), m, strides_in)
        end do
      end if
