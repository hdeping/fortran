...
!*****************************************************************************
      ...
      Program REAL_1D_CCS_DOUBLE_EX6
      ...
      real(8) :: X_OUT_2D(M_MAX+2,N_MAX)
      real(8) :: X_OUT   ((M_MAX+2)*N_MAX)
...
!
      ...
      call ZERO_INIT_REAL_D(X_OUT, (M_MAX+2)*N_MAX)
