...
!
!     Read input n - size of transform from input file complex_1d_single_ex2.d
!
      read *
      read *, n
...
!
      call INIT_COMPLEX_VECTOR_C(X_IN, n)
      call CCOPY(n, X_IN, 1, X_EXP, 1)
