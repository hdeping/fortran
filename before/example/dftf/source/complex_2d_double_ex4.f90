...
!
      ...
      do i=1, multiple
          call INIT_MULTIPLE_2D_COLUMNS_Z(X_IN_3D(i,1,1), m, n, strides_in)
      end do
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        print *
          do i=1, multiple
             print 908, i
             call PRINT_THREE_2D_COLUMNS_Z(X_IN_3D(i,1,1), m, strides_in)
          end do
      end if
