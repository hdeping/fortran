...
!*****************************************************************************
      ...
      Program REAL_1D_CCS_DOUBLE_EX4
      ...
      real(8) :: X_OUT_2D(M_MAX,N_MAX+2)
      real(8) :: X_OUT   (M_MAX*(N_MAX+2))
...
!
      ...
      call ZERO_INIT_REAL_D(X_OUT, M_MAX*(N_MAX+2))
...
!
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        call PRINT_THREE_VECTORS_D(X_OUT, n+2, dist_out, strides_out)
      end if
