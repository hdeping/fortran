...
!*****************************************************************************
      ...
      Program REAL_2D_PACK_SINGLE_EX6
      ...
      real(4) :: X_OUT_3D(M_MAX,N_MAX,K_MAX)
      real(4) :: X_OUT   (M_MAX*N_MAX*K_MAX)
...
!
      ...
      call ZERO_INIT_REAL_S(X_OUT,M_MAX*N_MAX*K_MAX)
      ...
      if (ADVANCED_DATA_PRINT) then
        ...
        print *, 'INPUT vector X (2D columns)'
          do i=1, multiple
              print *
              print 908, i
              call PRINT_THREE_FIRST_VECTORS_2D_S(X_IN_3D(1,i,1), lengths, strides_in)
          end do
      end if
