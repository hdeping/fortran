...
program main
    ...
    real(8),parameter          :: dx = 1E-2   ! the unit of x
    real(8)                    :: f_re(n,n)   ! the real part of the matrix
    real(8)                    :: f_im(n,n)   ! the imagine part of the matrix
    real(8)                    :: x_re(n)        ! the input array
    real(8)                    :: x_im(n)        ! the input array
    real(8)                    :: y_re(n)        ! the output array
    real(8)                    :: y_im(n)        ! the output array
    real(8)                    :: tmp
    real(8)                    :: t1
    real(8)                    :: t2
    integer                    :: i 
